...
export function makeMenu(task : any, estados : any, dificultades : any, nueva : boolean) {
...
export function searchMenu(taskList : Array<any>) {
...
export function viewMenu(taskList : Array <any>) {
